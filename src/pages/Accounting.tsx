...
import { useBusinessData, Transaction as BusinessTransaction } from "@/contexts/BusinessDataContext";
...
// Use the Transaction type from BusinessDataContext
type Transaction = BusinessTransaction;

const Accounting = () => {
  const { transactions, setTransactions } = useBusinessData();
  ...
  const { totalIncome, totalExpenses, netProfit } = useBusinessData();
