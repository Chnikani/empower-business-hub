...
import { businessService, type BusinessAccount } from '@/lib/businessService'
...
export const BusinessProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const refreshBusinesses = async () => {
    ...
    try {
      ...
      const data = await businessService.getBusinessAccountsByOwner(user.id)
  ...
  const createBusiness = async (name: string) => {
    ...
    try {
      ...
      const data = await businessService.createBusinessAccount(name, user.id)
